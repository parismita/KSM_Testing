...
if [ $# -ne 4 ]; then
    echo "Usage: $0 <pages_to_scan> <sleep_millisecs> <test_time> <outputfilename>"
    exit 1
fi
...
echo "$2" > /sys/kernel/mm/ksm/sleep_millisecs
test_time=$3
...
echo "FullScans,GeneralProfit,PagesShared,TotalPagesShared,PagesNotShared,PagesVolatile,KSM_CPU" >> $4
...
while [ $test_time -ne 0 ]; do
    ...
    echo "$full_scans,$general_profit,$total_pages_shared,$pages_currently_shared,$pages_nolonger_shared,$pages_volatile,$ksm_cpu" >> $4
